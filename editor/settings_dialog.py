...
FIELD_TOOLTIPS = {
    ...
    "gizmo.selection_bounds_color_r": "Selection bounds line red channel",
    "gizmo.selection_bounds_color_g": "Selection bounds line green channel",
    "gizmo.selection_bounds_color_b": "Selection bounds line blue channel",
...
_FIELD_RANGES = {
    ...
    "gizmo.selection_bounds_color_r": (0.0, 1.0),
    "gizmo.selection_bounds_color_g": (0.0, 1.0),
    "gizmo.selection_bounds_color_b": (0.0, 1.0),
